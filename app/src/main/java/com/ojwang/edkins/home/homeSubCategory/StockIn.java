...
public class StockIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText evBp = findViewById(R.id.evBuyingPrice);
        EditText evQuantity = findViewById(R.id.evQuantity);
        ...
        productBtn.setOnClickListener(v ->{
            if (evDate.getText().toString().trim().isEmpty()){
                ...
                Intent intent = new Intent(StockIn.this, StockList.class);
        ...
        storeBtn.setOnClickListener(v->{
            if (evDate.getText().toString().trim().isEmpty()){
                ...
                Intent intent = new Intent(StockIn.this, StoreList.class);
                intent.putExtra("DATE",evDate.getText().toString());
        ...
        saveBtn.setOnClickListener(v->{
            ...
            int b_Price = Integer.parseInt(evBp.getText().toString());
            ...
            if (stockId <= 0 || storeId<= 0){
                ...
                StockInModel stockInModel = new StockInModel(yearSet,monthSet,daySet,stockId,p_Name,storeId,s_Name,b_Price,quantity);
                mainViewModel.insertStockIn(stockInModel);
