...
@Entity(tableName = "stock_out_table", foreignKeys = {
...
public class StockOutModel {
    ...
    public StockOutModel(int year, String month, int day, int stockId, String productName, int storeId, String storeName, int sellingPrice, int quantity) {
        this.year = year;
        this.month = month;
        this.day = day;
